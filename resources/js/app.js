...
Vue.component(
    "create-new-stock-component",
    require("./components/main/inventory/CreateNewStockComponent.vue").default
);

Vue.component(
    "view-inventory-component",
    require('./components/main/inventory/ViewInventoryComponent.vue').default
);

Vue.component(
    "adjust-inventory-component",
    require('./components/main/inventory/adjustStockComponent.vue').default
);

// Order Components
Vue.component(
    "create-new-orders",
    require("./components/main/orders/CreateOrderComponent.vue").default
);

Vue.component(
    "view-order-component",
    require('./components/main/orders/ViewOrderComponent.vue').default
);

Vue.component(
    "update-order-component",
    require('./components/main/orders/UpdateOrderComponent.vue').default
); 

// Customers Components
Vue.component(
    "create-new-customer-component",
    require("./components/main/customers/AddNewCustomerComponent.vue").default
);

Vue.component(
    "view-customer-component",
    require('./components/main/customers/ViewCustomerComponent.vue').default
);

Vue.component(
    "update-customer-component",
    require('./components/main/customers/UpdateCustomerComponent.vue').default
);  

// Customers Components
Vue.component(
    "create-new-tea-type-component",
    require("./components/main/teaTypes/AddNewTeaTypeComponent.vue").default
);

Vue.component(
    "view-tea-type-component",
    require('./components/main/teaTypes/ViewTeaTypeComponent.vue').default
);

Vue.component(
    "update-tea-type-component",
    require('./components/main/teaTypes/UpdateTeaTypeComponent.vue').default
);     
/**
